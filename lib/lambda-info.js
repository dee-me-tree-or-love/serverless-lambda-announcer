...
module.exports = {
  ...
  getFunctionInfo(service, provider) {
    ...
    const funcs = service.getAllFunctions().map((func) => {
      const functionInfo = {};
   ...
   *
   * Written based on
   * https://github.com/serverless/serverless/blob/master/lib/plugins/aws/info/getStackInfo.js
   * Not covered by tests indeed...
   *
   * TODO: testing this would be really cool
   */
